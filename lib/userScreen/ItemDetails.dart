...
class ItemDetailes extends StatefulWidget {
  ...
  ItemDetailes(
      {this.imageRating, this.itemImage, this.itemName, this.itemprice});

  @override
  _ItemDetailesState createState() => _ItemDetailesState();
}

class _ItemDetailesState extends State<ItemDetailes> {
  void floatIconClick() {
